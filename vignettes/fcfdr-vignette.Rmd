...
We can use the `corr_plot` and the `stratified_qqplot` functions to visualise the relationship between $p$ and $q$. We observe that low $p$-values (i.e. high $-log10(p)$) are enriched for low $q$ values.
