...
along with either the indices of a subset of independent SNPs (`indep_index`) in `flexible_cfdr()` or the chromsome for which each SNP resides (`chr`) in `binary_cfdr()`.
